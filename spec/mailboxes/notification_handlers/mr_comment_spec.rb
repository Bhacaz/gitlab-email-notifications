...
# Specs for NotificationHandlers::MrComment
#
# Fixture:
#   mr_comment_1.eml  – top-level "commented" review comment on MR !199

RSpec.describe NotificationHandlers::MrComment do
  ...
  # ------------------------------------------------------------------
  # Fixture: mr_comment_1.eml
  # ------------------------------------------------------------------

  describe 'mr_comment_1.eml – top-level comment' do
    ...
    it 'sets reason to mr_comment' do
      inbound_email
    ...
    it 'includes the action phrase in the summary' do
      inbound_email
      expect(user.notifications.last.summary).to include('commented')
    end
