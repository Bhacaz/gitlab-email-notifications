...
# Specs for NotificationHandlers::MrApproved
#
# Fixture:
#   mr_approved.eml  – "Merge request !199 was approved" notification

RSpec.describe NotificationHandlers::MrApproved do
  ...
  # ------------------------------------------------------------------
  # Fixture: mr_approved.eml
  # ------------------------------------------------------------------

  describe 'mr_approved.eml – approval notification' do
    ...
    it 'sets reason to mr_approved' do
      inbound_email
    ...
    it 'includes the action phrase in the summary' do
      inbound_email
      expect(user.notifications.last.summary).to include('approved')
    end
